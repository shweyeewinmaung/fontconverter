...
<head>
   ...
   <title>Zawgyi to Unicode Converter</title>
   <style type="text/css">
      img.wp-smiley,
      img.emoji {
...
<body class="page-template-default page page-id-1518">
   <div id="container">
      <div id="header">
         <h1 id="header-title"><a href="#">Zawgyi to Unicode Converter</a></h1>
      </div><!-- #header -->
      ...
      <div id="head-nav">
         <div class="menu">
            <ul>
               ...
               <li class="page_item page-item-1518 current_page_item"><a href="http://localhost/zg2uni/new/zg2uni.php">Refresh</a></li>
            </ul>
         </div>
      <div class="clear"></div>
      </div><!-- #head-nav -->
      ...
      <div id="main-content">
         <div id="post-1518" class="post-1518 page type-page status-publish hentry">
            <div>
               <form method="POST">
                  <textarea name="unicode" id="unicode" style="width: 98%; height: 350px;font-size: 12px;"></textarea>
